...
from src.app import DateValidator
...
def test_format_handling(self):
    self.assertEqual(is_date("01.01.2023"), True, "2023-01-01")
    self.assertEqual(is_date("2023-01-01"), True, "2023-01-01")
    self.assertEqual(is_date("01.01.2023"), True, "01.01.2023")  # Проверка нормализации


def test_leap_years(self):
    self.assertEqual(is_date("29.02.2020"), True, "2020-02-29")
    self.assertEqual(is_date("29.02.2000"), True, "2000-02-29")
